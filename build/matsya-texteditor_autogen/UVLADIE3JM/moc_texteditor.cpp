...
QT_MOC_LITERAL(1, 11, 7), // "newPath"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 4), // "path"
QT_MOC_LITERAL(4, 25, 7) // "addPath"

    },
    "FileHelper\0newPath\0\0path\0addPath"
};
...
void FileHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addPath((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileHelper::newPath)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileHelper::newPath(const QString & _t1)
{
